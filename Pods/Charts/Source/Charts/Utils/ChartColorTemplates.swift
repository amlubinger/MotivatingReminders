...
open class ChartColorTemplates: NSObject
{
    @objc open class func liberty () -> [NSUIColor]
    {
        return [
            ...
            NSUIColor(red: 98/255.0, green: 131/255.0, blue: 149/255.0, alpha: 1.0)
        ]
    }
    ...
    @objc open class func joyful () -> [NSUIColor]
    {
        return [
            ...
            NSUIColor(red: 211/255.0, green: 63/255.0, blue: 73/255.0, alpha: 1.0)
        ]
    }
    ...
    @objc open class func pastel () -> [NSUIColor]
    {
        return [
            ...
            NSUIColor(red: 216/255.0, green: 219/255.0, blue: 226/255.0, alpha: 1.0)
        ]
    }
    ...
    @objc open class func colorful () -> [NSUIColor]
    {
        return [
            ...
            NSUIColor(red: 2/255.0, green: 103/255.0, blue: 193/255.0, alpha: 1.0)
        ]
    }
    ...
    @objc open class func vordiplom () -> [NSUIColor]
    {
        return [
            ...
            NSUIColor(red: 252/255.0, green: 252/255.0, blue: 252/255.0, alpha: 1.0)
        ]
    }
    ...
    @objc open class func material () -> [NSUIColor]
    {
        return [
            ...
            NSUIColor(red: 130/255.0, green: 2/255.0, blue: 99/255.0, alpha: 1.0),
            NSUIColor(red: 255/255.0, green: 107/255.0, blue: 53/255.0, alpha: 1.0)
        ]
    }
    
    @objc open class func light () -> [NSUIColor]
    {
        return [
            NSUIColor(red: 255/255.0, green: 59/255.0, blue: 48/255.0, alpha: 1.0),
            NSUIColor(red: 255/255.0, green: 149/255.0, blue: 0/255.0, alpha: 1.0),
            NSUIColor(red: 255/255.0, green: 204/255.0, blue: 0/255.0, alpha: 1.0),
            NSUIColor(red: 76/255.0, green: 217/255.0, blue: 100/255.0, alpha: 1.0),
            NSUIColor(red: 90/255.0, green: 200/255.0, blue: 250/255.0, alpha: 1.0),
            NSUIColor(red: 88/255.0, green: 86/255.0, blue: 214/255.0, alpha: 1.0)
        ]
    }
